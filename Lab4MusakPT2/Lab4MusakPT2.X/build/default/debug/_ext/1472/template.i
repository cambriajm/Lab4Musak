...
Setup:
   ; add device setup here
    ...
    MOVLW 0xFF
    MOVWF 0x86 ;TRISB set ((PORTB) and 07Fh), 0 as input
...
ButtonTest:
    BTFSC 0x06,0 ;testing if there is the button on rb7 being pressed
    MOVWF ButtonValue
    BTFSC 0x06,1 ;testing if there is the button on rb6 being pressed
    MOVWF ButtonValue
    BTFSC 0x06,2 ;testing if there is the button on rb5 being pressed
    MOVWf ButtonValue
    BTFSC 0x06,3 ;testing if there is the button on rb4 being pressed
    MOVWF ButtonValue
    BTFSC 0x06,4 ;testing if there is the button on rb3 being pressed
    MOVWF ButtonValue
    BTFSC 0x06,5 ;testing if there is the button on rb2 being pressed
    MOVWF ButtonValue
    BTFSC 0x06,6 ;testing if there is the button on rb1 being pressed
    MOVWF ButtonValue
    BTFSC 0x06,7 ;testing if there is the button on rb0 being pressed
    MOVWF ButtonValue
...
LookupTable:
    MOVF ButtonValue,W
    ADDWF PCL,1
    RETLW 0xEE ;note C3, ((PORTB) and 07Fh), 0
    RETLW 0xD4 ;note B3, ((PORTB) and 07Fh), 1
    RETLW 0xBD ;note A3, ((PORTB) and 07Fh), 2
    RETLW 0xB2 ;note G3, ((PORTB) and 07Fh), 3
    RETLW 0x9F ;note F3, ((PORTB) and 07Fh), 4
    RETLW 0x8E ;note E3, ((PORTB) and 07Fh), 5
    RETLW 0x7E ;note D3, ((PORTB) and 07Fh), 6
    RETLW 0x77 ;note C3, ((PORTB) and 07Fh), 7
