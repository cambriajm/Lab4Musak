...
FINAL_IMAGE=${DISTDIR}/DelayLab.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/template.o
POSSIBLE_DEPFILES=${OBJECTDIR}/template.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/template.o
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/DelayLab.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F883
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/DelayLab.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/template.o: template.S  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/template.o 
	${MP_AS} -mcpu=PIC16F883 -c \
	-o ${OBJECTDIR}/template.o \
	template.S \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/DelayLab.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F883 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/DelayLab.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
