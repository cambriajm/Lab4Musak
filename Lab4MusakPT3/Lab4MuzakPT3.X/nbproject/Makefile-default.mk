...
FINAL_IMAGE=${DISTDIR}/Lab4MuzakPT3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../mainA.S

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1472/mainA.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1472/mainA.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1472/mainA.o
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Lab4MuzakPT3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F883
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Lab4MuzakPT3.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/_ext/1472/mainA.o: ../mainA.S  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/_ext/1472" 
	@${RM} ${OBJECTDIR}/_ext/1472/mainA.o 
	${MP_AS} -mcpu=PIC16F883 -c \
	-o ${OBJECTDIR}/_ext/1472/mainA.o \
	../mainA.S \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Lab4MuzakPT3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F883 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Lab4MuzakPT3.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
